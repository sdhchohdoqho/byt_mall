...
<head>
    ...
    <link rel="stylesheet" href="../../../static/CSS/payment-Wechat.css">
            ...
            <div class="col-xs-12 row">
                <div class="col-xs-8 row paymentarea">
                    <ul class="nav nav-tabs col-xs-12" style="padding: 0;">
                        <li role="presentation" class="payment-selection"><a class="payment-a" href="payment-Alipay.jsp">支付宝</a></li>
                        <li role="presentation" class="active payment-selection"><a class="payment-a" href="payment-Wechat.jsp" style="border-bottom: unset !important;">微信</a></li>
