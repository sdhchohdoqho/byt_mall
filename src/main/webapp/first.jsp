        ...
        <div class="container-fluid" style="background-color:#333333;height: 40px;">
            ...
            <div>
                <ul class="nav navbar-nav">
                    ...
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li><a href="" style="font-size:1.5rem;margin-top: -6px">商品发布</a></li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li><a href="house certain.jsp" style="font-size:1.5rem;margin-top: -6px">我的购物车</a></li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li><a href="" style="font-size:1.5rem;margin-top: -6px">用户中心</a></li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    ...
                    <li><a href="login" style="font-size:1.5rem;margin-top: -6px">登录</a></li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li>&nbsp&nbsp&nbsp&nbsp</li>
                    <li><a href="regist" style="font-size:1.5rem;margin-top: -6px">注册</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-lg-5 col-sm-5">
                ...
                <div class="panel panel-primary" onmouseout="makevisible(this,50)" onmouseover="makeavisible(this,80)" style="opacity:0.5">
                    ...
                    <div class="panel-heading" onmouseout="makevisible(this,50)" onmouseover="makeavisible(this,80)">
                ...
                <img src="1.png" onmouseout="makevisible(this,50)" onmouseover="makeavisible(this,80)" style="opacity:0.5">
            ...
            <div class="col-lg-3">
                <h4 class="text-left" style="color:#FFFF00">——尼古拉斯.瑞年.张</h4>
                <br>
                <div class="panel panel-warning"style="margin-right:15%;color:#668B8B;opacity: 0.6"onmouseout="makevisible(this,50)" onmouseover="makeavisible(this,80)" >
                    <div class="panel-heading">

                        <div class="input-group" style="color:#FF00FF">
                ...
                <div class="panel panel-info" style="margin-right:15%"onmouseout="makevisible(this,50)" onmouseover="makeavisible(this,80)" style="opacity:0.6">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body" style="height:200px">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="请在此键入您的用户名">
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon">密码</span>
                            <input type="text" class="form-control" placeholder="请在此键入您的密码">


                        </div>
                        <br><br>

                        <button type="button" class="btn btn-primary pull-left ">登录</button>&nbsp&nbsp&nbsp<button type="button" class="btn btn-primary pull-right">注册</button>
