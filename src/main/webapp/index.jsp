...
<header>
  ...
  <div class="top center">
    ...
    <div class="right fr">
      <div class="gouwuche fr"><a href="http://localhost:8091/shoppingcar">购物车</a></div>
      <div class="fr">
        <ul>
        ...
        <div class="pop">
          <div class="left fl">
            <div>
              ...
              <div class="xuangou_right fr"><a href="xiangqing.jsp" target="_blank">选购</a></div>
              <div class="clear"></div>
            </div>
            <div>
              <div class="xuangou_left fl">
  ...
  function getbasicinfo() {
    ...
    xmlhttp.onreadystatechange=function() {
      if (xmlhttp.readyState==4 && xmlhttp.status==200) {
        window.alert("getbasic执行了")
        var basicinfo=JSON.parse(xmlhttp.responseText);
        var tbody = document.getElementById('good');
        for(var i = 0;i < 5; i++){ //遍历一下json数据
          tbody.innerHTML += getDataRow(basicinfo[i]);
        }
      }
    }
    xmlhttp.open("GET","http://localhost:8091/good/list",true);
    xmlhttp.send();
  }
  function getDataRow(h) {
    return '<div class="mingxing fl">'+
             '<div class="sub_mingxing"><a target="_blank href=http://localhost:8091/xiangqing.jsp?id='+h.id +'"><img src='+h.imgurl+' alt=""></a></div>'+
			 '<div class="pinpai"><a href="">'+h.name+'</a></div>'+
			 '<div class="youhui">'+h.subtitle+'</div>'+
			 '<div class="jiage">'+ h.price + h.topprice +'</div>'+
			 '</div>'
  }
</script>
</html>