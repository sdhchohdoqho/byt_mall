        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="panel panel-info" style="margin-right:15%"onmouseout="makevisible(this,50)" onmouseover="makeavisible(this,80)" style="opacity:0.6">
                    <div class="panel-heading">
                        <h3 class="panel-title">欢迎回来，${username}</h3>
                    </div>
                    <div class="panel-body" style="height:200px">
                        ...
                        大家一起努力让这里变得更加<ruby><rb><span style="TEXT-DECORATION: line-through;opacity: 1;">和谐</rb><rp>（</rp><rt style="font-size:0.5em">混乱</rt><rp>）</rp></ruby>吧！
                        </p>
                        <br>
                        有问题的话，请转向
                            <a href="link.jsp">联系我们</a>
