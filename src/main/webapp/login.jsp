            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == "success") {
                        alert("登陆成功");
                        window.location.href="http://localhost:8091/hello.jsp";

                    } else {
                        alert("您的登录信息出现了一点问题"+data.data.errMessage);
                    }
                },
                error: function (data) {
            ...
            <div class="col-lg-7">
                ...
                <div class="panel panel-danger"onmouseout="makevisible(this,50)" onmouseover="makeavisible(this,80)" style="opacity:0.5;margin-left: 15%;margin-right: 15%;height: 500px">
                    ...
                    <div class="panel-body">
                        <h4 style="text-align:center;color:#7B68EE;font-weight:bold;">登录蓂雪の淘宝系统，优质商品任你挑</h4>
                        <br>
                        <br>
                        <br>
                        ...
                        <form action="logincheck" method="post" >
                            ...
                            <div style="width:100%;text-align:center">
                                <input type="text" id="username" name="user.user_Name" size="30" placeholder="请在此键入您的用户名" style=" border-bottom: black 1px solid;    border-top-style: none;    border-right-style: none;    border-left-style: none;    background-color: transparent;width:300px" />
                            ...
                            <br>
                            <div style="width:100%;text-align:center">
                                <input type="password" id="userpassword" name="user.user_Password"  size="30" placeholder="请在此键入您的密码" style=" border-bottom: black 1px solid;    border-top-style: none;    border-right-style: none;    border-left-style: none;    background-color: transparent;width: 300px" />
                            </div>
                            <br/>
                            <br/>
                            <br>
                            ...
                            <div align="center">
                                <div style="width:70%;">
                                    <input type="submit" id="login" class="btn btn-primary btn-lg btn-block" value="登录"/>
